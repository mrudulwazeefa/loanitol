...
<<<<<<< HEAD
      <button type="button" class="btn-md-red d-flex justify-content-center" data-bs-toggle="modal"
          data-bs-target="#emicalculator">
          <img src="assets/home/icons/calculator.svg" alt="" class="">
      </button>
      <button type="button" class="btn-md-blue d-flex justify-content-center" data-bs-toggle="modal"
                  ...
                  <ul class="nav nav-pills item_p" id="pills-tab" role="tablist">
                      <li class="nav-item" role="presentation">
                          <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                              data-bs-target="#home-loan" type="button" role="tab" aria-controls="pills-home"
                              aria-selected="true">Home <span>Loan</span></button>
                      </li>
                      <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                              data-bs-target="#personal-loan" type="button" role="tab" aria-controls="pills-profile"
                              aria-selected="false">Personal
                              <span>Loan</span></button>
                      </li>
                      <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                              data-bs-target="#business-loan" type="button" role="tab" aria-controls="pills-contact"
                              aria-selected="false">Business
                              <span>Loan</span></button>
                      </li>
                  </ul>
                  <div class="tab-content" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="home-loan" role="tabpanel"
              ...
              document.querySelectorAll(".slider").forEach(slider => {
                  slider.addEventListener("input", function() {
                      ...
                      this.style.background =
                          `linear-gradient(to right, #d71920 0%, #d71920 ${value}%, #eee ${value}%, #eee 100%)`;
                  });
              });
              </script>
          </div>
