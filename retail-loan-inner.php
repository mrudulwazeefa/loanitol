...
<title>Retail Loan Inner Page | Loanitol</title>
</head>
...
<body>
    ...
    <section class="section mt-5 py-5" id="overview">
        <div class="container mb-5">
            ...
            <p>Retail loans are designed to empower you by providing the financial support you need, when you need
                it. Whether it’s funding a dream vacation, home renovation, or managing unexpected expenses, our
                flexible retail loan options have you covered. With competitive interest rates and easy repayment
                plans, we ensure that your financial journey is smooth and hassle-free.</p>
            <p>Our quick approval process and minimal documentation make getting a loan simpler than ever. Let us
    ...
    <div class="section" id="product-details">
            ...
            <div class="row py-3">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Purpose-Driven Financing: Retail loans tailored for personal goals, from
                            vacations to renovations.</p>
                    </div>
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Flexible Tenures: Choose a repayment plan that fits your budget and
                            lifestyle.</p>
                    </div>
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Competitive Rates: Enjoy attractive interest rates to keep your finances
                            stress-free.</p>
                    </div>
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Quick Approval: Fast processing ensures you get funds when you need them
                            most.</p>
                    </div>
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Minimal Documentation: Hassle-free application with simple paperwork.</p>
                    </div>
                    <div class="d-flex mb-2">
                        <img class="me-3" src="assets/retail-loan-inner/icons/logo-red.svg" alt="">
                        <p class="m-0">Loanitol Advantage: Experience seamless borrowing with Loanitol’s expert
        ...
        <div class="container py-3">
            <h2 class="fw-semibold">Product Details</h2>
            <p>Smartly Compare Rates with Our Loan Rate Tool <br><br>
                Finding the best loan rates has never been easier. Our rate comparison tool simplifies the process,
                helping you evaluate multiple retail loan offers in one place. Compare interest rates, repayment terms,
                and other key features effortlessly. Save time and make informed decisions that suit your financial
                goals. <br><br>
                Whether you're planning for big dreams or managing daily needs, our tool ensures you get the best value.
                Empower yourself with clarity and confidence—choose the loan that's perfect for you.</p>
        </div>
    </div>
