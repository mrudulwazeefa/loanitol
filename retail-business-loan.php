...
<body>
    ...
    <div class="loan-against-property-overview-and-loan-section py-5">
        <div class="overview py-5">
            <div class="container">
                ...
                <p>An unsecured credit that can assist you in meeting the immediate financial needs of your expanding
            ...
            <div class="row py-5">
                <div class="col-12 col-md-6 d-flex">
                    <div class="card w-100 text-white p-4">
                        <ul class="mb-0">
                            <li>Easy to Apply: You may apply online to have your business loan approved in a few simple
                                steps.</li>
                            ...
                            <li>
                                ...
                                payments for the duration of the loan, or a flexible OD, in which you pay interest on
                ...
                <div class="col-12 col-md-6 d-flex mt-3 mt-md-0">
                    <div class="card w-100 text-white p-4">
                        <ul class="mb-0">
                            ...
                            <li>A variety of ways for determining eligibility, such as certificate-based funding (only
                                for professionals) or loan eligibility workout using financial papers and banking
                                average methods</li>
                            <li>Fast Approval and Fast Disbursal: grant business loan applications with prompt approval.
            ...
            <div class="row py-3">
                <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <ul>
                        ...
                        <li>Age: age should be at least 21 years at the time of applying for the business loan and not
                        ...
                        <li>Cash Flow:  Lenders often evaluate your business's cash flow to determine your ability to
                            repay the loan.</li>
                        <li>Nationality:  Indian citizens</li>
                        <li>Eligible Entities:  Individuals, MSMEs, Sole Proprietorships, Partnership Firms, Public and
                            Private Limited Companies, Limited Liability Partnerships, retailers, traders,
                            manufacturers, and other non-farm income-generating business entities engaged only in the
                        ...
                        <li>Business Type:  Most lenders provide loans to various types of businesses, including sole
                            proprietorships, partnerships, limited liability companies (LLCs), corporations, and more
                        </li>
                    </ul>
                </div>
    ...
    <div class="fees-and-charges-section text-white position-relative">
        ...
        <img class="position-absolute bottom-0" height="100px" src="assets/retail-business-loan/multi-logo2.png" alt="">
