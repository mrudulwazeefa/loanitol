...
<title>Loan Against Property Page | Loanitol</title>
</head>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-8 col-md-8">
                    ...
                    <p style="color: #221E1E">Unlock the value of your property with easy financing.
                    </p>
                </div>
            ...
            <div class="container py-3">
                ...
                <div class="row py-3">
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="d-flex">
                            <img src="assets/retail-home-loan-against-property/icons/loanitol-red-logo.svg" alt="">
                            <h5 class="ms-3">Self Employed Professional
                            </h5>
                        </div>
                        <ul>
                            <li>Address Proof</li>
            ...
            <div class="row d-flex flex-column flex-sm-row">
                <div class="col-12 col-sm-6 d-flex align-items-center">
                    <div class="div">
                        ...
                        <h4 class="fw-semibold">Interest Rate: </h4>
