...
<title>Retail Home Loan Page | Loanitol</title>
</head>
...
<body>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-8 col-md-8">
                    ...
                    <h5 class="h5-size col-sm-12">
                        ...
                        Your dream home is within reach. <br> Discover our wide range of <br> <span
                            class="d-inline-block">Home Loan Options</span>
                    </h5>
                    <p style="color: #221E1E">Step into your dream home with ease and affordability
                    </p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <img src="assets/retail-home-loan/banner.png" class="img-fluid" alt="Referral Partner Banner">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="overview-and-loan-section ">
        <section class="section py-5" id="overview">
            <div class="overview py-5">
                <div class="container">
                    ...
                    <p>The amount that a person loans from a financial institution to build a home, repair or expand an
                        existing one, or purchase a new or resale property is known as a home loan. The loan is taken
                        out at
                ...
                <div class="container">
                    ...
                    <div class="row py-4">
                            ...
                            <div class="row g-3 g-md-4">
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/Loan.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home/Flat <br> Purchase Loans</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/home-construction-loan.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home <br> Construction Loan</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/home-extension-loan.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home <br> Extension Loan</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/home-improvement-loan.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home <br> Extension Loan</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/home-transfer-loan.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home <br> Extension Loan</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-4">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        <span>
                                            <img src="assets/retail-home-loan/icons/seller-bt.svg" alt="">
                                        </span>
                                        <p class="mb-0 title">Home <br> Extension Loan</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 mt-3 mt-md-0">
                            <div class="card-img  justify-content-center text-center h-100">
                                <img src="assets/retail-home-loan/medium-shot-couple-holding-small-house.jpg"
                                    class="object-fit-cover w-100" height="364px" style="border-radius: 10px" alt="">
                            </div>
                        </div>
                    </div>

                    <!-- Right side: 1 card or empty space -->
    ...
    <section class="section" id="fees">
        <div class="fees-and-charges-section text-white position-relative">
            <img class="position-absolute end-0" height="100px" src="assets/retail-home-loan/multi-logo.png" alt="">
            <img class="position-absolute bottom-0" height="100px" src="assets/retail-home-loan/multi-logo2.png" alt="">
            <div class="container py-5">
                <div class="row d-flex flex-column flex-sm-row py-3">
                    <div class="col-12 col-sm-6 d-flex align-items-center">
                        <div class="div">
                            ...
                            <p>Home loan interest rates starting from <span style="color: #FDD835">8.5% onwards</span>
                            </p>
                        </div>
                    </div>
