        ...
        <div class="row d-flex align-items-stretch p-0">
            ...
            <div class="col-xl-8 col-md-7 col-lg-7 col-sm-12 my-3 px-3">
                <div class="card  article-card-1 p-4 border-0 position-relative">
                    ...
                    <img class="article-main-img img-fluid rounded-sm" src="assets/articles/article-1.jpg" alt="">
                    <h5 class="card-title py-4 mb-0">ലോണുകൾ ഇനി എളുപ്പത്തിൽ,ബുദ്ധിമുട്ടുകൾ<br> ഇല്ലാതെ</h5>
