...
<title>Business Loan | Loanitol</title>
</head>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-8 col-md-8">
                    ...
                    <h5 class="h5-size col-sm-12">
                        Unlock Your Business Potential with <span>Flexible Financing</span>
                    </h5>
                    <p>Strategic financing solutions tailored for growing businesses.
                    </p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <img src="assets/business-loan/banner.png" class="img-fluid" alt="Referral Partner Banner">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sticky-nav-wrapper container" id="scrolling-nav">
        <div class="container d-flex align-items-center justify-content-between">
            <button class="arrow-btn d-flex align-items-center" onclick="scrollNav(-200)">
                <img src="assets/business-loan/icons/left-arrow.svg" alt="left-arrow" width="25"
                    class="right-arrow">
            </button>
            <div class="box--style">
            ...
            <button class="arrow-btn d-flex align-items-center" onclick="scrollNav(200)">
                <img src="assets/business-loan/icons/right-arrow.svg" alt="right-arrow" width="25"
                    class="left-arrow">
            </button>
        </div>
    </div>
        ...
        <div class="empower-section">
            <div class="container">
                ...
                <p>An unsecured credit that can assist you in meeting the immediate financial needs of your
                    expanding company is a business loan. To raise the money needed to grow your current company, increase
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-8">
                        ...
                        <ul class="pt-3">
                            ...
                            <li>Age: age should be at least 21 years at the time of applying for the business loan and not more than 65 years at the time of loan maturity</li>
                            <li>Credit score : Your credit score should be good</li>
                            <li>Business should be profitable</li>
                            <li>Business account: Must have a bank account in the name of Firm maintaining average bank balance</li>
                            ...
                            <li>Eligible Entities: Individuals, MSMEs, Sole Proprietorships, Partnership Firms, Public and Private Limited Companies, Limited Liability Partnerships, retailers, traders, manufacturers, and other non-farm income-generating business entities engaged only in the services, trading, and manufacturing sectors</li>
                            <li>Business Type: Most lenders provide loans to various types of businesses, including sole proprietorships, partnerships, limited liability companies (LLCs), corporations, and more.
                            </li>
                        </ul>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4 mt-3 mt-sm-0 d-none d-md-none d-lg-block">
                        <div class="card-img responsive-height justify-content-center text-center h-100">
                            <img src="assets/business-loan/card-img.jpg" class="object-fit-cover h-100 w-100" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="linear-gradient2 business-loan">
            <div class="documents-required-home-loan py-5">
                <div class="container py-3">
                    <h4 class="mb-3 h4-size2">Documents Required</h4>
                    <div class="row py-3">
