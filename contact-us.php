          ...
          <div class="row rowStyle">
              <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="floatingInput" placeholder="Enter Your Name" name="name" required="">
                      <label for="floatingInput">Enter Your Name</label>
                  </div>
                  <div class="form-floating mb-3">
                      <input type="email" class="form-control" id="floatingInput" placeholder="Enter Email Address" name="email" required="">
                      <label for="floatingInput">Enter Email Address</label>
                  </div>
                  <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="phone" placeholder="Enter Phone Number" name="phone" oninput="validatePhoneNumber(event)" required="">
                      <label for="floatingInput">Enter Phone Number</label>
                  </div>
                  <div class="form-floating mb-3">
                      <select class="form-select form-control" id="inputDistrict" name="place" aria-label="Floating label select example" required="">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="form-floating mb-3 form-floating-custom">
                    <select class="form-select form-control" id="inputLoan" name="loan" aria-label="Floating label select example" required="">
                        <option value="" disabled="" selected="" hidden=""></option>
                  ...
                  <div class="form-floating mb-3 form-floating-custom">
                      <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="comments" required=""></textarea>
