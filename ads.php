...
<body>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0">
                                <video id="modalVideo" controls loop autoplay playsinline class="responsive-video">
                    ...
                    <div class="modal-dialog modal-body modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body modal-dialog modal-dialog-centered">
                                <video id="modalVideo" width="450" height="600" controls loop autoplay>
                                    <source src="assets/videos/Episode_008_Reel__004_New.mp4" type="video/mp4">
    ...
    if (exampleModal) {
        exampleModal.addEventListener('hidden.bs.modal', function() {
            var videos = exampleModal.querySelectorAll('video');
