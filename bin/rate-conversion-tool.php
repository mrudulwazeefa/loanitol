...
<link
    ...
    <style>
      ...
      @media (max-width: 768px) {
        ...
        .chart-container {
          height: 190px; /* Reduced from 200px */
        }
      }
...
<body>
    ...
    <div class="header">
      <h1><i class="fas fa-percentage"></i> Smart Loan Rate Comparison</h1>
      <p>
        Compare your current loan rates with better options and see how much you
        can save
      </p>
    </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label for="loanAmount"
              ><i class="fas fa-money-bill-wave"></i> Loan Amount (₹)</label
            >
          ...
          <div class="form-group">
            <label for="currentRate"
              ><i class="fas fa-percentage"></i> Current Interest Rate</label
            >
          ...
          <div class="form-group">
            <label for="newRate"
              ><i class="fas fa-sync-alt"></i> New Interest Rate</label
            >
            <div class="range-container">
              <input
                type="range"
          ...
          <div class="form-group">
            <label for="loanTerm"
              ><i class="fas fa-clock"></i> Loan Term (Years)</label
            >
            <select id="loanTerm">
          ...
          <div class="form-group">
            <label for="extraPayment"
              ><i class="fas fa-plus-circle"></i> Extra Monthly Payment
              (₹)</label
            >
            <div class="input-with-icon">
              <i class="fas fa-rupee-sign"></i>
    ...
    <div class="footer">
      <p>
        © 2023 Smart Loan Solutions | Helping Indians save on loans since 2010
      </p>
      <div class="contact-info">
        ...
        <div class="contact-item">
          <i class="fas fa-envelope"></i> contact@smartloansolutions.com
        </div>
        <div class="contact-item">
          <i class="fas fa-map-marker-alt"></i> Mumbai, Delhi, Bangalore
        </div>
      </div>
    </div>
            ...
            data: {
              ...
              datasets: [
                ...
                },
                {
                  ...
                  backgroundColor:
                    currentInterest > newInterest ? "#5cb85c" : "#e74c3c",
                },
              ],
            },
            options: {
