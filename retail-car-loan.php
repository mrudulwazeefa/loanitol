...
<body>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-8 col-md-8">
                    ...
                    <h5 class="h5-size col-sm-12">
                        ...
                        <br> Flexible <span class="d-inline-block">Car Financing</span>
                    </h5>
                    <p style="color: #221E1E">Own your dream car with simple and convenient financing.
                    </p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <img src="assets/retail-car-loan/banner.png" class="img-fluid" alt="Referral Partner Banner">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="loan-against-property-overview-and-loan-section">
        <section id="overview" class="section py-4">
            <div class="overview py-5 pb-0">
                <div class="container">
                    <h2 class="mb-3 fw-semibold">Overview</h2>
                    <p>A car loan is a secured loan made by banks and financial organizations to assist individuals
                        purchase
                        a new or used automobile. The loan amount is reimbursed in monthly installments (EMIs) over a
                        predetermined tenure, and the car itself acts as collateral until the loan is fully paid off.
                    </p>
                </div>
            </div>
        </section>
                            ...
                            <div class="row g-3 g-md-4">
                                <div class="col-6 col-sm-4 col-md-3">
                                    <div class="card justify-content-center text-center h-100 p-3">
                                        ...
                                        <p class="mb-0 title">New Car Loan</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-4 col-md-3">
                                    <div class="card justify-content-center text-center h-100 p-3">
                ...
                <div class="row py-5">
                    ...
                    <div class="col-12 col-md-4 d-flex mt-3 mt-md-0">
                        <div class="card-img w-100 text-white">
                            <img src="assets/retail-car-loan/card-img.jpg" height="250px" class="object-fit-cover w-100"
