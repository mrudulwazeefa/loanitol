...
<title>Blog2 Page | Loanitol</title>
</head>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-12">
                    <h6 class="h6-size col-sm-10 mb-0">
                        <span style="color: #5B5B5D">Blog</span>
                    </h6>
                </div>
            </div>
        </div>
            ...
            <div class="row py-5">
                    ...
                    <div class="card border-0 p-4">
                        <div class="card-body">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <h4 class="my-2">30-Year Home Loan: Dream Home or Debt Trap? Master Your Long-Term Loan
                                    with Smart
                                    Planning</h4>
                                <p class="m-0" style="color: #8B8787">Author Name : XXXX Thomas Date :02 Apr 2020 </p>
                                <a href="" class="mt-3 fw-semibold">Read more <img class="ms-2"
                                        src="assets/blog3/icons/red-arrow.svg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 d-flex">
                    <div class="card border-0 p-4">
                        <div class="card-body">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <h4 class="my-2">Navigating the World of Loans: Your Guide to Different Types and How to
                                    Get Them
                                </h4>
                                <p class="m-0" style="color: #8B8787">Author Name : XXXX Thomas Date :02 Apr 2020 </p>
                                <a href="" class="mt-3 fw-semibold">Read more <img class="ms-2"
                ...
                <div class="col-sm-6 col-lg-4 d-flex">
                    <div class="card border-0 p-4">
                        <div class="card-body">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <h4 class="my-2">Golden Rules for Smart Borrowing: Your Essential Loan Checklist</h4>
                                <p class="m-0" style="color: #8B8787">Author Name : XXXX Thomas Date :02 Apr 2020 </p>
                                <a href="" class="mt-3 fw-semibold">Read more <img class="ms-2"
                                        src="assets/blog3/icons/red-arrow.svg" alt=""></a>
                            </div>
                ...
                <div class="col-sm-6 col-lg-4 d-flex mt-4 mt-4">
                    <div class="card border-0 p-4">
                        <div class="card-body">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <h4 class="my-2">What Would You Rather Pay: Home Loan EMI or Rent? Don't Lose Your Mind
                                    and Money On
                                    It</h4>
                                <p class="m-0" style="color: #8B8787">Author Name : XXXX Thomas Date :02 Apr 2020 </p>
                                <a href="" class="mt-3 fw-semibold">Read more <img class="ms-2"
                ...
                <div class="col-sm-6 col-lg-4 d-flex mt-4 mt-4">
                    <div class="card border-0 p-4">
                        <div class="card-body">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <h4 class="my-2">Is Your Home Loan an Asset or a Liability? Understanding the Nuance
                                </h4>
                                <p class="m-0" style="color: #8B8787">Author Name : XXXX Thomas Date :02 Apr 2020 </p>
                                <a href="" class="mt-3 fw-semibold">Read more <img class="ms-2"
                                        src="assets/blog3/icons/red-arrow.svg" alt=""></a>
